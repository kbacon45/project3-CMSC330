...
let test_nfa_accept _ =
  ...
  let m2 =
    { qs= [0; 1; 2]
    ; sigma= ['a'; 'b']
    ; delta= [{input=Some 'a'; states=(0, 1)}; {input=Some 'b'; states=(0, 2)}]
    ; q0= 0
    ; fs= [2] }
  in
  assert_nfa_deny m2 "" ;
...
let test_nfa_to_dfa _ =
  let m1 =
    { qs= [0; 1; 2; 3]
    ; sigma= ['a'; 'b']
    ; delta= [{input=Some 'a'; states=(0, 1)}; {input=Some 'a'; states=(0, 2)}; {input=Some 'b'; states=(2, 3)}]
    ; q0= 0
    ; fs= [1; 3] }
  in
...
let test_nfa_closure _ =
  let m1 =
    {qs= [0; 1]; sigma= ['a']; delta= [{input=Some 'a'; states=(0, 1)}]; q0= 0; fs= [1]}
  in
  assert_nfa_closure m1 [0] [0] ;
  assert_nfa_closure m1 [1] [1] ;
  let m2 = {qs= [0; 1]; sigma= []; q0= 0; delta= [{input=None; states=(0, 1)}]; fs= [1]} in
  ...
  let m4 =
    ...
    ; q0= 0
    ; fs= [2]
    ; delta= [{input=None; states=(0, 1)}; {input=None; states=(0, 2)}] }
  in
...
let test_nfa_move _ =
  ...
  let m2 = {qs= [0; 1]; sigma= ['a']; delta= [{input=None; states=(0, 1)}]; q0= 0; fs= [1]} in
  ...
  let m4 =
    ...
    ; q0= 0
    ; fs= [2]
    ; delta= [{input=None; states=(0, 1)}; {input=Some 'a'; states=(0, 2)}] }
  in
...
let test_nfa_new_states _ =
  ...
  { qs= [0; 1; 2; 3; 4]
  ; sigma= ['a'; 'b']
  ; delta= [{input=Some 'a'; states=(0, 1)}; {input=Some 'a'; states=(0, 2)}; {input=Some 'b'; states=(2, 3)}; {input=None; states=(2, 4)}; {input=Some 'a'; states=(4, 4)}]
  ; q0= 0
  ; fs= [1; 3] } in
